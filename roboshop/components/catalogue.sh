...
# sudo sed -e -i 's/MONGO_DNSNAME/mongo.roboshop.internal/' /etc/systemd/system/catalogue.service
sudo sed -e -i 's/MONGO_DNSNAME/mongo.roboshop.internal/' "$APPUSER_HOME/systemd.service"
